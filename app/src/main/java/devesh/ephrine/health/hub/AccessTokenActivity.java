...
LinearLayout LLAccessData=(LinearLayout)findViewById(R.id.LLAccessData);
       ...
       for (int j = 1; j < t; j++) {
           Drawable SampleDrawable = getResources().getDrawable(R.drawable.pdf1);
...
*/
 ...
 /*           DatabaseReference date = database.getReference("app/users/" + UserUID + "/accessdata/"+j+"/date");
