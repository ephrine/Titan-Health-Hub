...
public class PrescriptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            ...
            DatabaseReference GetTotal = database.getReference("app/users/" + UserUID + "/data/Prescriptions/total");
                ...
                if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(action)) {
                    ...
                    if (c.moveToFirst()) {
                        ...
                        if (DownloadManager.STATUS_SUCCESSFUL == c
                            ...
                            startActivity(i);
                            Toast.makeText(PrescriptionActivity.this, "Download Complete",
            ...
            public void run() {
                ...
                View.OnClickListener clicks = new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase database = FirebaseDatabase.getInstance();
                        DatabaseReference urldata = database.getReference("app/users/" + UserUID + "/data/Prescriptions/" + S + "/url");
                        urldata.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if (value != null) {
                                    ...
                                    menuDownload();
                                    View PrescLLMenu = (View) findViewById(R.id.PrescLLMenu);
                                    PrescLLMenu.setVisibility(View.VISIBLE);
                                    ImageView im = (ImageView) findViewById(R.id.imageView);
                                    TextView tt = (TextView) findViewById(R.id.textView20);
                ...
                for (int j = 1; j < t; j++) {
                    ...
                    final CardView mcard = new CardView(PrescriptionActivity.this);
                    ...
                    LinearLayout LL = new LinearLayout(PrescriptionActivity.this);
                    ...
                    ImageView img = new ImageView(PrescriptionActivity.this);
                    ...
                    LinearLayout LL1 = new LinearLayout(PrescriptionActivity.this);
                    ...
                    final TextView tx = new TextView(PrescriptionActivity.this);
                    ...
                    final TextView tx1 = new TextView(PrescriptionActivity.this);
                    ...
                    FirebaseDatabase database = FirebaseDatabase.getInstance();
                    final int idj = j;
                    DatabaseReference title = database.getReference("app/users/" + UserUID + "/data/Prescriptions/" + j + "/title");
                    ...
                    DatabaseReference desc = database.getReference("app/users/" + UserUID + "/data/Prescriptions/" + j + "/desc");
    ...
    public void LayoutDownload(View v) {
        ...
        Toast.makeText(PrescriptionActivity.this, "Download in Progress",
                Toast.LENGTH_SHORT).show();
    ...
    public void LayoutDelete(View v) {
        // Write a message to the database
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference del = database.getReference("app/users/" + UserUID + "/data/Prescriptions/" + SlotNo);
        del.removeValue();
        ...
        final Intent ab = new Intent(this, PrescriptionActivity.class);
    ...
    public void menuDownload() {
        ...
        DatabaseReference title = database.getReference("app/users/" + UserUID + "/data/Prescriptions/" + SlotNo + "/title");
        title.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // This method is called once with the initial value and again
        ...
        DatabaseReference desc = database.getReference("app/users/" + UserUID + "/data/Prescriptions/" + SlotNo + "/desc");
        desc.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // This method is called once with the initial value and again
    ...
    public void closeRec(View v) {
        View PrescLLMenu = (View) findViewById(R.id.PrescLLMenu);
        PrescLLMenu.setVisibility(View.GONE);
    }
    ...
    public void closeUpload(View v) {
        ...
        uploadFAB = (FloatingActionButton) findViewById(R.id.PrescUploadFABbutton);
...
// Create a storage reference from our app
        ...
        StorageReference storageRef = storage.getReferenceFromUrl("gs://healthhub-fb351.appspot.com/app/users/" + UserUID + "/data/Prescriptions");
...
// Register observers to listen for when the download is done or if it fails
    ...
    public void AddDataBase() {
        ...
        // Title
        DatabaseReference titleData = database.getReference("app/users/" + UserUID + "/data/Prescriptions/" + no + "/title");
        titleData.setValue(RTitle);

        // desc
        DatabaseReference descData = database.getReference("app/users/" + UserUID + "/data/Prescriptions/" + no + "/desc");
        if (RDesc != null) {
        ...
        //Download URL
        DatabaseReference downloadURLData = database.getReference("app/users/" + UserUID + "/data/Prescriptions/" + no + "/url");
        downloadURLData.setValue(DownloadURL);

        // Add total
        DatabaseReference Total = database.getReference("app/users/" + UserUID + "/data/Prescriptions/total");
    ...
    public void onActivityResult(int requestCode, int resultCode,
        ...
        //    uploadView = (View) findViewById(R.id.UploadView);
          ...
          //  uploadFAB.setVisibility(View.GONE);
            ...
            tx.setText("Create Prescription");
      ...
      /*          //PowerPoint
                ...
                */
                // Word
                    ...
                    Toast.makeText(PrescriptionActivity.this, "Oops!! Only PDF and Word File Formats are allowed",
