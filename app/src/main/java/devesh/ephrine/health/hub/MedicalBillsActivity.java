...
public class MedicalBillsActivity extends AppCompatActivity {
...
public String Country;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            ...
            DatabaseReference GetTotal = database.getReference("app/users/" + UserUID + "/data/MedicalBills/total");
                ...
                if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(action)) {
                    ...
                    if (c.moveToFirst()) {
                        ...
                        if (DownloadManager.STATUS_SUCCESSFUL == c
                            ...
                            startActivity(i);
                            Toast.makeText(MedicalBillsActivity.this, "Download Complete",
                                    Toast.LENGTH_SHORT).show();

                        }if(DownloadManager.STATUS_FAILED==16){
                            Toast.makeText(MedicalBillsActivity.this, "Download Failed... Check your Internet Connection",
                                    Toast.LENGTH_SHORT).show();
            ...
            public void run() {
                ...
                View.OnClickListener clicks = new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase database = FirebaseDatabase.getInstance();
                        DatabaseReference urldata = database.getReference("app/users/" + UserUID + "/data/MedicalBills/" + S + "/url");
                ...
                for (int j = 1; j < t; j++) {
                    ...
                    final CardView mcard = new CardView(MedicalBillsActivity.this);
                    ...
                    LinearLayout LL = new LinearLayout(MedicalBillsActivity.this);
                    ...
                    ImageView img = new ImageView(MedicalBillsActivity.this);
                    if(Country.equals("IN")){
                        Drawable DOCDrawable = getResources().getDrawable(R.drawable.financialin);
                    ...
                    LinearLayout LL1 = new LinearLayout(MedicalBillsActivity.this);
                    ...
                    final TextView tx = new TextView(MedicalBillsActivity.this);
                    ...
                    final TextView tx1 = new TextView(MedicalBillsActivity.this);
    ...
    public void LayoutDownload(View v) {
        ...
        Toast.makeText(MedicalBillsActivity.this, "Download in Progress",
                Toast.LENGTH_SHORT).show();
    ...
    public void LayoutDelete(View v) {
        // Write a message to the database
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference del = database.getReference("app/users/" + UserUID + "/data/MedicalBills/" + SlotNo);
        del.removeValue();
        ...
        final Intent ab = new Intent(this, MedicalBillsActivity.class);
    ...
    public void menuDownload() {
        ...
        DatabaseReference title = database.getReference("app/users/" + UserUID + "/data/MedicalBills/" + SlotNo + "/title");
        title.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // This method is called once with the initial value and again
        ...
        DatabaseReference desc = database.getReference("app/users/" + UserUID + "/data/MedicalBills/" + SlotNo + "/desc");
        desc.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // This method is called once with the initial value and again
    ...
    public void closeUpload(View v) {
        ...
        uploadFAB = (FloatingActionButton) findViewById(R.id.UploadFABbutton);
...
// Create a storage reference from our app
        ...
        StorageReference storageRef = storage.getReferenceFromUrl("gs://healthhub-fb351.appspot.com/app/users/" + UserUID + "/data/MedicalBills");
...
// Register observers to listen for when the download is done or if it fails
    ...
    public void AddDataBase() {
        ...
        // Title
        DatabaseReference titleData = database.getReference("app/users/" + UserUID + "/data/MedicalBills/" + no + "/title");
        titleData.setValue(RTitle);

        // desc
        DatabaseReference descData = database.getReference("app/users/" + UserUID + "/data/MedicalBills/" + no + "/desc");
        if (RDesc != null) {
        ...
        //Download URL
        DatabaseReference downloadURLData = database.getReference("app/users/" + UserUID + "/data/MedicalBills/" + no + "/url");
        downloadURLData.setValue(DownloadURL);

        // Add total
        DatabaseReference Total = database.getReference("app/users/" + UserUID + "/data/MedicalBills/total");
      ...
      /*          //PowerPoint
                ...
                */
                // Word
                    ...
                    Toast.makeText(MedicalBillsActivity.this, "Oops!! Only PDF and Word File Formats are allowed",
...
if(FileStorageVal!=null){
    ...
    FloatingActionButton UploadFab=(FloatingActionButton)findViewById(R.id.UploadFABbutton);
